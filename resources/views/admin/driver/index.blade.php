...
border-radius: 10px;">
                <div class="card-header">
                    <h2 class="text-dark-gray fw-bolder fs-3 d-flex align-items-center gap-5 mb-0">
                        <span class="material-icons" style="color:#264A8A"> text_snippet </span> Data Driver
                    </h2>
                </div>
                <div class="d-flex flex-column flex-lg-row flex-stack py-5 px-9"
                    ...
                    <div class="d-flex flex-column flex-lg-row gap-5 align-items-lg-center w-100">
                        <label for="search_driver" class="fs-4">Search</label>
                ...
                <div class="card-body py-0">
                    <table id="tabelDriver" class="table">
                        <thead>
                            <tr>
...
@section('js')
@include('admin.driver.javascript')
@endsection