<div class="form_data row gy-5 g-xl-8 d-none">
    ...
    border-radius: 10px;">
            <div class="card-header border-0 d-flex align-items-center justify-content-between position-sticky top-0 bg-white" style="z-index: 99;">
                ...
                <h2 class="text-dark-gray fw-bolder fs-3 d-flex align-items-center gap-5 mb-0 d-none dataDriver">Data Driver</h2>
            ...
            <div class="card-body py-0 mt-5 pt-5">
                <form onsubmit="onSave(event)" class="d-flex flex-wrap gap-5 justify-content-center" id="formDriver" name="formDriver" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id">
                    <div class="d-flex flex-column gap-1 pe-5" style="width:49%">
                        <label for="kode_driver" class="fw-bolder">Kode Driver</label>
                        <input type="text" name="kode_driver" id="kode_driver" required placeholder="Masukkan Kode Driver" class="border-0 py-4 px-5" style="
                                    background-color: #fafafa;
                                    border-radius: 6px;
                                    " required />
                    </div>
                    <div class="d-flex flex-column gap-1 pe-5" style="width:49%">
                        <label for="nama" class="fw-bolder">Nama Driver</label>
                        <input type="text" name="nama" id="nama" required placeholder="Masukkan Nama Driver" class="border-0 py-4 px-5" style="
                                    background-color: #fafafa;
                                    border-radius: 6px;
                                    " required />
                    </div>
                    <div class="d-flex flex-column gap-1 pe-5" style="width:49%">
                        <label for="status" class="fw-bolder">Status Driver</label>
