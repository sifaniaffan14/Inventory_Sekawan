<div class="accident-card card pb-6 mb-5 mb-xl-8">
    <div class="card-header border-0 align-items-center">
        <h2 class="text-dark-gray fw-bolder fs-3 mb-0"> Divisi </h2>
    </div>
    <div class="card-body py-0 mt-5">
        <form action="javascript:onSave()" method="post" id="formDivisi" name="formDivisi" autocomplete="off" enctype="multipart/form-data" class="d-flex flex-column gap-5">
		    @csrf
            <input type="hidden" name="id">
            <div class="fv-row d-flex flex-column gap-1">
                <label for="nama_divisi" class="required fw-bolder fs-5">Nama Divisi</label>
                <input type="text" name="nama_divisi" id="nama_divisi" placeholder="Masukkan Nama Divisi" class="border-0 py-4 px-5 fs-5" style="
