...
border-radius: 10px;">
                <div class="card-header">
                    <h2 class="text-dark-gray fw-bolder fs-3 d-flex align-items-center gap-5 mb-0">
                        <span class="material-icons" style="color:#264A8A"> text_snippet </span> Data Karyawan
                    </h2>
                </div>
                <div class="d-flex flex-column flex-lg-row flex-stack py-5 px-9"
                    ...
                    <div class="d-flex flex-column flex-lg-row gap-5 align-items-lg-center w-100">
                        <label for="search_karyawan" class="fs-4">Search</label>
                        <div class="position-relative w-lg-50">
                            <input type="search" name="search_karyawan" id="search_karyawan"
...
@section('js')
@include('admin.karyawan.javascript')
@endsection